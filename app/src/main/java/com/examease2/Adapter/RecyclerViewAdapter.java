...
import com.examease2.Activities.Enrolled_Course;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.student_cardview_course,parent,false);
    ...
    public void onBindViewHolder(MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.cardView.setOnClickListener(l ->{
                Intent intent = new Intent(mContext, Enrolled_Course.class);
